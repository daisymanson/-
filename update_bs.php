...
if($_SESSION['account'] != null)
{
	...
	$id = $_GET['id'];
$ret=mysql_query("select * from bs where `account` = '".$account."'and `id`='".$id."'",$link);	
...
<h2 align="center">修改血糖</h2><br/><br/><br/><br/><br/>
<form name="form" method="post" action="update_bs2.php">
<table align="center">
<tr><td>飯前血糖值：</td><td><input type="text" name="bs" value="<?php echo $row['bs'];?>"/></td></tr>
...
<tr><td colspan="2" align="center"><input type="button"style="width:100" name="btn2" value="回上一頁" onClick="this.form.action='select_bs.php';this.form.submit();"/></td></tr>
</table>
</form>
</body>
<?php     
